...
const SinglePage = () => {
  ...
  const aboutData = [
    ...
    },
    {
      slug: 'about-author',
      title: 'About Author',
      description: 'This app was developed by Isai Cespedes, a self-taught web developer and a technical writer. He is opened to freelance Gig. So go ahead and connect with Isai on Twitter @Lordkaito_.',
    },
  ];
